...
git clone "https://github.com/kenshin17/Nginx-RestrictIP-Redis.git" "$SOURCES_FOLDER/restrictip-lua"
#wget "http://nginx.org/download/nginx-1.9.9.tar.gz" -O "$SOURCES_FOLDER/nginx-1.9.9.tar.gz"
git clone "https://github.com/kenshin17/modsecurity-2.8.0.git" "$SOURCES_FOLDER/modsecurity-2.8.0"

echo "Extracting nginx-1.9.9.tar.gz"
cp -R nginx-1.9.9 "$SOURCES_FOLDER/"
